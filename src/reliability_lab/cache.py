...
class ResponseCache:
    ...
    def similarity(a: str, b: str) -> float:
        """Compute semantic similarity between two strings using cosine over words + character 3-grams."""
        if a == b:
            return 1.0
...
class SharedRedisCache:
    ...
    def get(self, query: str) -> tuple[str | None, float]:
        ...
        cached_exact = self._redis.hget(exact_key, "response")
        if cached_exact is not None:
            return cached_exact, 1.0
